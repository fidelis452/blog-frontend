				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							...
							<p class="overview"><b>Michael Holz</b><br />
								Seo Analyst at <a href="#">OsCorp Tech.</a></p>
						...
						<div class="carousel-item">
							...
							<p class="overview"><b>Paula Wilson</b><br />
								Media Analyst at <a href="#">SkyNet Inc.</a></p>
							<div class="star-rating">
								<ul class="list-inline">
									<li class="list-inline-item"><i class="fa fa-star"></i></li>
									<li class="list-inline-item"><i class="fa fa-star"></i></li>
						...
						<div class="carousel-item">
							...
							<p class="overview"><b>Antonio Moreno</b><br />
								Web Developer at <a href="#">Circle Ltd.</a></p>
							<div class="star-rating">
								<ul class="list-inline">
									<li class="list-inline-item"><i class="fa fa-star"></i></li>
									<li class="list-inline-item"><i class="fa fa-star"></i></li>
